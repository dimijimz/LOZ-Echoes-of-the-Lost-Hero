...
def generate_fixed_room(room_number):
    ...
    rooms = {
        1: {"width": 4, "height": 4, "objects": {(2, 2): "Chest", (4, 4): "Locked Door"}},
        2: {"width": 5, "height": 5, "objects": {(1, 1): "Chest", (4, 4): "Locked Door"}},
        3: {"width": 5, "height": 6, "objects": {(3, 3): "Chest", (5, 5): "Locked Door"}},
        4: {"width": 5, "height": 5, "objects": {(2, 2): "Chest", (4, 4): "Locked Door"}},
        5: {"width": 6, "height": 6, "objects": {(3, 3): "Chest"}},  # Room 5 with Echo Lens upgrade
        6: {"width": 6, "height": 6, "objects": {(3, 3): "Chest", (6, 6): "Locked Door"}}, # Continue with larger rooms after Echo Lens upgrade
        7: {"width": 7, "height": 7, "objects": {(2, 2): "Chest", (5, 5): "Locked Door"}},
